 ...
 * @since       1.6
 */
class Jnt_HanhphucControllerAlbum extends JControllerForm
{
	/**
	...
	public function batch($model = null)
	{
		...
		// Preset the redirect
		$this->setRedirect(JRoute::_('index.php?option=com_jnt_hanhphuc&view=albums' . $this->getRedirectToListAppend(), false));
