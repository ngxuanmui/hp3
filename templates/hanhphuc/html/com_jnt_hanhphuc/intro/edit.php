...
<div class="float-left left-side">
		<div class="sub-container">
			...
			<form style="margin-top: 20px;" id="business-info" name="userForm" action="<?php echo JRoute::_('index.php?option=com_jnt_hanhphuc&task=intro.save'); ?>" method="post" class="form-validate" enctype="multipart/form-data">
			    <div>
			        <ul>
			            <li>
